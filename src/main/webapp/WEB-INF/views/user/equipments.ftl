                ...
                <#list equipmentList as eq>
                    <tr data-equip-id="${eq.id}">
                        <td>
                            ...
                            <input class="editfield" type="text" name="type" value="${eq.type!}" required maxlength="64"
                                   style="display:none;">
                        </td>
                        <td>
                            <span class="readonly">${eq.brand!}</span>
                            <input class="editfield" type="text" name="brand" value="${eq.brand!}" required
                                   maxlength="64" style="display:none;">
                        </td>
                        <td>
                            <span class="readonly">${eq.model!}</span>
                            <input class="editfield" type="text" name="model" value="${eq.model!}" required
                                   maxlength="64" style="display:none;">
                        </td>
                        <td>
                            <span class="readonly">${eq.serialNumber!}</span>
                            <input class="editfield" type="text" name="serialNumber" value="${eq.serialNumber!}"
                                   required maxlength="64" style="display:none;">
                        </td>
                        <td>
                            <span class="readonly">${eq.description!}</span>
                            <input class="editfield" type="text" name="description" value="${eq.description!}" required
                                   style="display:none;">
                        </td>
                        <td>
                            <button type="button" class="editBtn">Изменить</button>
                            <form action="/user/equipments" method="post" class="editForm"
