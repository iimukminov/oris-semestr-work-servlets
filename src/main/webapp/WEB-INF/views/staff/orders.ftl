...
<#macro page_body>
    ...
    <table border="1" id="freeOrdersTable">
        <thead>
        <tr>
            <th>ID</th>
            <th>Клиент</th>
        ...
        <#list freeOrders as order>
            <tr data-order-id="${order.id}">
                ...
                <td>
                    <#list order.services as service><div>${service.name}</div></#list>
                </td>
                <td>
                    <#list order.parts as partQuantity><div>${partQuantity.part.name}: ${partQuantity.quantity}</div></#list>
                </td>
                <td>${order.price!} ₽</td>
                <td>
    ...
    <h2>Мои заявки</h2>
    <table border="1" id="myOrdersTable">
        <thead>
        <tr>
            <th>ID</th>
            <th>Клиент</th>
